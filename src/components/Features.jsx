  ...
  return (
    <div className=" mt-20 text-left">
        ...
        <div className="flex flex-col items-start justify-center max-w-[900px] mx-auto">
            ...
            <section>
                <div className="row-1 row flex items-center justify-center gap-4 mt-6">
                    <div className="card p-8 bg-primary-50 h-[307px] w-[416px] rounded-md">
                ...
                <div className="row-2 row flex items-center justify-center gap-4 mt-6">
                    <div className="card bg-primary-50 h-[312px] w-[270px] rounded-md p-6">
